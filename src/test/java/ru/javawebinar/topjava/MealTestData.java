...
public class MealTestData {
    ...
    public static final int MEAL_USER_4_ID = START_SEQ + 5;
    public static final int MEAL_USER_5_ID = START_SEQ + 6;
    public static final int MEAL_USER_6_ID = START_SEQ + 7;
    public static final int MEAL_ADMIN_1_ID = START_SEQ + 8;
    public static final int MEAL_ADMIN_2_ID = START_SEQ + 9;
    ...
    public static final Meal MEAL_USER_4 = new Meal(MEAL_USER_4_ID, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000);
    public static final Meal MEAL_USER_5 = new Meal(MEAL_USER_5_ID, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500);
    public static final Meal MEAL_USER_6 = new Meal(MEAL_USER_6_ID, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510);
